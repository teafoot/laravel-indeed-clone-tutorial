...
jQuery(function () {
  ...
  (function renderAllSkills() {
    var skills = JSON.parse($("[data-skills]").attr("data-skills"));
    var append = "";
  ...
  (function renderOldSkills() {
    var oldSkills = JSON.parse($("[data-old-skills]").attr("data-old-skills")); // null object or string value
    // console.log(typeof oldSkills, oldSkills);

    if (oldSkills) {
      // string value
      oldSkills = oldSkills.split(",").forEach(function (oldSkill) {
        selectedSkills.add(oldSkill);
      }); // array

      $('#skills').val(_toConsumableArray(selectedSkills)); // convert Set to Array ; agregar las habilidades seleccionadas al input hidden
  ...
  function clasesCSS(skill) {
    var defaultCSS = "border border-gray-500 px-10 py-3 mb-3 rounded mr-4 ";
    var dynamicCSS = selectedSkills.has(skill) ? 'bg-teal-400' : '';
...
/***/ 4:
/*!********************************************!*\
  !*** multi ./resources/js/lista-skills.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! C:\Users\pedro\Desktop\DevProjects\LaravelProjects\6.juan-de-la-torre\curso-laravel-crea-aplicaciones-y-sitios-web-con-php-y-mvc\004 devjobs\resources\js\lista-skills.js */"./resources/js/lista-skills.js");
